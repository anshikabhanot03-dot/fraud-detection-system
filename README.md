...
The system trains supervised and unsupervised fraud models, compares them with imbalance-aware metrics, selects a business threshold using false-positive and false-negative costs, and exposes the selected model.
